...
Route::middleware('auth')->group(function (){
    ...
    Route::get('/upload-document', [DocumentController::class, 'uploadDocumentIndex'])->name('uploadDocument');
    Route::post('/upload-document', [DocumentController::class, 'uploadDocumentStore'])->name('uploadDocument.store');
